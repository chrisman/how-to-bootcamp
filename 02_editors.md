...
Learn your text editor the way that a master chef learns their knives: practice until it becomes an extension of your hands and you can use it effortlessly.
...
I've found vim to be peerless because of its composable commands, its macros and registers, and the fact that it keeps you in the shell. That said, I've been using vim for over a decade, casually at first, and then daily as a professional, and I still once a week or so google how to do something in it. It's possible that no one person may ever learn and know all its features, but that's no reason to not learn, use, and master the parts of it that are most useful to you.
...
I didn't use Atom that much for that long. It was slow, and I didn't feel as productive and quick when using it. But here are a few plugins I remember liking. (Go to _Settings_ and _Install_ to search for and install packages.)
